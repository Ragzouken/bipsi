define("ace/mode/ink", ["require","exports","module",
"ace/lib/oop",
"ace/mode/text",
"ace/tokenizer",
...
"ace/range"
    ...
    const TextHighlightRules = require("../mode/text_highlight_rules").TextHighlightRules;
    const BaseFoldMode = require("../mode/folding/fold_mode").FoldMode;
